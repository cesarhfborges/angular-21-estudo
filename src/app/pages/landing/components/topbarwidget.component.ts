    ...
    template: `<a class="flex items-center" href="#">
        ...
        >
            ...
            <div class="flex border-t lg:border-t-0 border-surface py-4 lg:py-0 mt-4 lg:mt-0 gap-2">
                <p-button pRipple label="Login" routerLink="/auth/login" [rounded]="true" [text]="true"></p-button>
                <p-button pButton pRipple label="Register" routerLink="/auth/login" [rounded]="true"></p-button>
